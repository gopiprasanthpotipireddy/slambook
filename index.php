...
<style>
body{margin-top:-2px
background-image:url(theme/gg.jpg)
}
table{margin:auto;}
...
<table width="100%" height="100%" border="0">
  <tr>
    <td height="165" colspan="2" bgcolor="#663399" style=""><h1 align="center"><font color="#FFFF00" face="cursive">Slam Book</h1></td>
  </tr>
  <tr>
...
body {
	background: #DCDDDF url(theme/gg.jpg);
	color: #000;
	font: 14px Arial;
	margin: 0 auto;
	padding: 0;
...
<h1>Login Form</h1>
			<div>
				<input type="text" placeholder="20135060xx" name="e" required/>
			</div>
			<div>
    <input type="password" placeholder="Your Password" name="p" required/>
			</div>
			<div>
  ...
  <tr>
    <td colspan="2" align="center">Developed By Gopiprasanth</td>
  </tr>
</table>
</body>
</html>
